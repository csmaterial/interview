...
![计算机经网络体系结构]([https://raw.githubusercontent.com/huihut/interview/master/images/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BB%8F%E7%BD%91%E7%BB%9C%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84.png]
)
...
如果一个端口的TCP进程结束了，一段时间之内，该端口还会不会被分配？  
TCP协议中，TCP_NODELAY和TCP_NOPUSH的两个参数的含义  
TCP三次握手  
cookies和 session原理和机制  
IIS服务启动失败，应该做什么检查，查看端口占用的具体命令（先查日志，根据日志判断）  
拥塞窗口  
TCP和UDP区别  
http协议状态  
TCP/IP  
